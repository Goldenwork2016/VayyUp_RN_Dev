...
function VideoFeed({
  ...
  const share = async (image, routeType) => {
    const options = {
      ...
      // url: `http://vayyup.com/${routeType}/${item.id}`,
    };
    Share.open(options)
      .then((res) => {
      })
                ...
                <VUView flexDirection="row" alignItems="center">
                  ...
                  <VUView>
                    <VUView flexDirection="row">
                      <VUText color="#fff" fontSize={14} fontFamily={AppStyles.fontName.poppinsBold} color={AppStyles.color.grayText}>
                        {item.user.name}
                      </VUText>
                      {followLoading ? (
                        <ActivityIndicator color="#E9326D" animating={true} />
                          ...
                          following.find((obj) => obj.id === item.uid) != undefined ? (
                            <VUTouchableOpacity borderColor={AppStyles.color.btnColor} ml={2} borderWidth={1} borderRadius={24} width={60} height={20} onPress={handleOnUnfollowPressed}>
                              <VUText textAlign='center' fontSize={12} fontFamily={AppStyles.fontName.poppins} color={AppStyles.color.btnColor}>
                                Unfollow
         </VUText>
                            </VUTouchableOpacity>
                          ) : (
                              <VUTouchableOpacity borderColor={AppStyles.color.btnColor} ml={2} borderWidth={1} borderRadius={24} width={50} height={20} onPress={handleOnFollowPressed}>
                                <VUText textAlign='center' fontSize={12} fontFamily={AppStyles.fontName.poppins} color={AppStyles.color.btnColor}>
                                  Follow
           </VUText>
                              </VUTouchableOpacity>
                    ...
                    <VUText color="#fff" fontSize={12} weight="normal">
                      {item.title}
                    </VUText>
                  </VUView>
                </VUView>
