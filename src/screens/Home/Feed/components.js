...
export const FeedProfileImage = styled(VUImage).attrs({ size: 40, borderRadius: 20 })``;

export const RightFrame = styled(Header).attrs({ right: "0px", bottom: '120px' })``;
...
export const CommentIcon = memo(() => {
    return <IonIcon size={28} name="chatbubble-ellipses-outline" color={AppStyles.color.btnColor} />;
}, areEqual);
export const ShareIcon = memo(() => {
    return <IonIcon size={26} name="share-social-sharp" color={AppStyles.color.btnColor} />;
}, areEqual);
export const FlagIcon = memo(() => {
    return <FontAwesomeIcon name="flag" color={AppStyles.color.btnColor} />;
}, areEqual);
export const TrashIcon = memo(() => {
    return <FontAwesomeIcon size={26} name="trash-o" color={AppStyles.color.btnColor} />;
}, areEqual);

export const DownloadIcon = memo(() => {
    return <FeatherIcon size={26} name="download" color={AppStyles.color.btnColor} />
}, areEqual);
...
export const FollowButton = memo(({ onPress }) => {
    return <VUTouchableOpacity borderColor={AppStyles.color.btnColor} ml={2} borderWidth={1} borderRadius={24} width={50} height={20} onPress={onPress}>
