...
const Competition = () => {
  ...
  return (
    <SafeAreaView bg={AppStyles.color.bgColor}>
      <VUScrollView>
        <VUView flex={1} bg={AppStyles.color.bgColor} pb={50}>
          <LinearGradient colors={['#0C0B54', '#0C0B54', '#F84030']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} >
            <VUView
              alignItems="center"
              py={3}
            >
              <VUText mt={2} fontSize={16} fontFamily={AppStyles.fontName.poppinsBold} color={AppStyles.color.grayText}>
                Competitions
            </VUText>
            </VUView>
          </LinearGradient>
                ...
                <VUView>
                  <VUView flexDirection="row">
                    ...
                    <VUView
                      ...
                      mx={2}>
                      <VUView width="85%">
                        <VUText fontSize={14} fontFamily={AppStyles.fontName.poppinsSemiBold} color={AppStyles.color.white} mb={1}>
                          {competition.title}
                        </VUText>
                        <VUTouchableOpacity onPress={handleCompetitionPressed.bind(
                          ...
                          <VUText fontSize={12} fontFamily={AppStyles.fontName.poppins} textAlign='center' color={AppStyles.color.grayText}>Participate</VUText>
                        </VUTouchableOpacity>
                      </VUView>
                      <VUTouchableOpacity  onPress={handleVideoPressed.bind(this, competition)}  justifyContent='center' alignItems='center'>
                        <VUText fontSize={12} fontFamily={AppStyles.fontName.poppins} style={{textDecorationLine:'underline'}} textAlign='center' color={AppStyles.color.btnColor}>See All</VUText>
                      </VUTouchableOpacity>
                    </VUView>
                  </VUView>
                </VUView>
